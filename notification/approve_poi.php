...
class approve_poi extends \phpbb\notification\type\base
{
	/**
	...
	*/
	...
	{
		return 'mot.usermap.notification.type.approve_poi';
	}
	...
	*/
	...
	{
		return $this->language->lang('USERMAP_NOTIFY_POI_APPROVE', $this->get_data('poi_name'), $this->get_data('display_username'));
	}
	...
	*/
	...
	{
		return '@mot_usermap/approve_poi';
	}
