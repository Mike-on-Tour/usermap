...
$lang = array_merge($lang, [
	...
	'ACP_USERMAP_ROWS_PER_PAGE_EXP'		=> 'Wählen Sie hier die Anzahl der Zeilen, die pro Tabellenseite in den anderen Reitern angezeigt werden soll.',
	...
	'ACP_USERMAP_GOOGLE_TEXT'			=> 'geonames.org liefert nur für bestimmte Länder ein Ergebnis (vgl. dazu diese %1$sListe</span></a>),
											...
											genutzt werden. Diese Nutzung können Sie hier einschalten.<br>
											Dazu wird ein API Key benötigt, den Sie durch Anmeldung bei %2$sGoogle Maps API Key</span></a> erhalten. Folgen Sie
											bitte den dortigen Anweisungen und beachten Sie, dass Sie die ´Geocoding API´ aktivieren müssen.',
	...
	'ACP_USERMAP_GOOGLE_FORCE_TXT'		=> 'geonames.org wertet aus Copyright-Gründen für einige Länder nur Teile der Postleitzahl aus, dies führt zu sehr groben
											Ergebnissen beim Feststellen der Koordinaten, die betroffenen Länder können Sie %1$shier</span></a>nachlesen.<br>
	...
	'ACP_USERMAP_DATABASE_NAME_EXP'		=> 'Sie können hier zur besseren Unterscheidung einen Namen für diesen Ort vergeben.',
	...
	'ACP_USERMAP_POI_VISIBLE_EXP'		=> 'Wählen Sie hier, ob dieser POI auf der gewählten Kartenebene angezeigt werden soll.',
	...
	'ACP_USERMAP_POI_DELETE'			=> 'Sind Sie sicher, dass Sie den POI „<strong>%1$s</strong>“ aus der Datenbank löschen möchten?<br>
	...
	'ACP_USERMAP_LAYER_NAME_EXP'		=> 'Geben Sie hier einen Namen ein, unter dem Sie diese Kartenebene erkennen können.',
	'ACP_USERMAP_LAYER_TYPE_USER'		=> 'Mitglieder',
	'ACP_USERMAP_LAYER_TYPE_POI'		=> 'POI',
	'ACP_USERMAP_LAYER_ACTIVE'			=> 'Ebene aktiviert',
	'ACP_USERMAP_LAYER_ACTIVE_EXP'		=> 'Wählen Sie hier „Ja“, wenn diese Kartenebene aktiv, also benutzbar sein soll. Deaktivierte Kartenebenen können nicht für
											die Anzeige ausgewählt werden.',
	'ACP_USERMAP_SHOW_LAYER'			=> 'Immer anzeigen',
	'ACP_USERMAP_SHOW_LAYER_EXP'		=> 'Wählen Sie hier „Ja“, wenn diese Kartenebene immer sichtbar sein soll, also schon beim Aufruf der Mitgliederkarte.<br>
											Wenn Sie „Nein“ wählen, muss der Nutzer die Anzeige dieser Kartenebene über die Anzeige-Kontrolle aktivieren.',
	'ACP_USERMAP_LAYER_CLUSTERS'		=> 'Marker bündeln',
	'ACP_USERMAP_LAYER_CLUSTERS_EXP'	=> 'Wenn Sie diese Einstellung aktivieren, werden die Marker zur Darstellung auf der Karte gebündelt.
											Damit kann eine Überfrachtung der Karte mit Markern verhindert werden.',
	'ACP_USERMAP_LAYER_LANG_VAR'		=> 'Sprachvariablen',
	'ACP_USERMAP_LAYER_LANG_VAR_EXP'	=> 'Geben Sie hier die Begriffe ein, die in den auf deinem Board installierten Sprachen den Nutzern in der Anzeige-Kontrolle
	...
	'ACP_USERMAP_LAYER_ICON_EXP'		=> 'Wählen Sie hier die Icon-Datei, die in dieser Kartenebene als Standard gilt. Sie wird automatisch für alle POIs angezeigt,
	...
	'ACP_USERMAP_PERMITTED_GROUPS_EXP'	=> 'Kartenebenen für Mitglieder können angezeigt werden, wenn eine Berechtigung zum Sehen der Mitglieder vergeben wurde,
											Kartenebenen für POIs können angezeigt werden, wenn POIs aktiviert wurden die Berechtigung zum Sehen von POIs vergeben
											wurde.<br>
											Hier können Sie diese Berechtigungen individuell für jede Kartenebene auf bestimmte Hauptgruppen mit diesen
											Berechtigungen weiter beschränken, indem Sie die Gruppen auswählen, die diese Kartenebene sehen sollen.<br>
	...
	'ACP_USERMAP_LAYER_DELETE'			=> 'Sind Sie sicher, dass Sie die Kartenebene „<strong>%1$s</strong>“ aus der Datenbank löschen möchtest?<br>
